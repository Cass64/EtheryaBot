...
#------------------------------------------------------------------------- Commandes d'économie : /calcul
    ...
    @commands.tree.command(name="embed", description="Créer un embed personnalisé")
    ...
    @commands.tree.command(name="frags")
    async def frags(self, interaction: discord.Interaction, user: discord.Member):
    ...
    @commands.tree.command(name="frags_time")
    async def frags_timeleft(self, interaction: discord.Interaction, user: discord.Member):
    ...
    @commands.command(name="pret10k")
    async def pret10k(self, ctx, membre: discord.Member):
    ...
    @commands.command(name="pret25k")
    async def pret25k(self, ctx, membre: discord.Member):
    ...
    @commands.command(name="pret50k")
    async def pret50k(self, ctx, membre: discord.Member):
    ...
    async def enregistrer_pret(self, ctx, membre, montant, montant_rendu, duree):
    ...
    async def terminer(self, ctx, membre: discord.Member):
    ...
    @commands.tree.command(name="pret")
    ...
    async def pret(self, interaction: discord.Interaction, membre: discord.Member, montant: int, montant_à_rendre: int, duree: str, methode: str):
    ...
    async def enregistrer_pret(self, interaction: discord.Interaction, membre: discord.Member, montant: int, montant_à_rendre: int, duree: str, methode: str):
        """Enregistre un prêt avec détails et envoie un message dans le salon staff."""
    ...
    @commands.tree.command(name="pretpayer")
    async def pretpayer(self, interaction: discord.Interaction, membre: discord.Member):
        """Marque un prêt comme 'Payé' si l'utilisateur avait un prêt en cours."""
        if not any(role.name == GF_REQUIRED_ROLE for role in interaction.user.roles):
            await interaction.response.send_message("❌ Tu n'as pas le rôle requis pour utiliser cette commande.", ephemeral=True)
            return
